...
//       if(+formData.regularPrice < +form.discountedPrice) return setError('Discount price must be lower than regular price')
//       setLoading(true);
//       setError(false);
...
//             <span className='font-normal text-gray-700 ml-2'>The first image will be the listing cover (Max 6)</span>
//             </p>
